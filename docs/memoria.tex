...
\bigskip
$filas = fs \cdot d_s \cdot \frac{f_max}{fs}$ 
\bigskip
Donde, en nuestro caso, $fs = 48000hz$, $d_s = 0.1s$ y $f_max = 5000hz$

\bigskip
Al reducir los segundos que utizamos de las muestras, además de hacer que tarden menos en entrenarse las redes,
también estamos intentando mejorar el funcionamiento de nuestro modelo, ya que se puede funcionar bien
...
\begin{itemize}
	...
	\item Ratio de aprendizaje: $0.001$
