...
Tras los buenos resultados del sistema, podemos concluir su gran utilidad para diferenciar y clasificar todas las notas del piano de forma efectiva y
con niveles de precisión muy elevados.
En sí misma, esta funcionalidad podría ser utilizada en múltiples herramientas de afinación o de aprendizaje elemental
