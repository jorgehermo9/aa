...
cliclos de entrenamiento de 1500 en las aproximaciones pasdas a 200.
...
Esto nos ayudará a disminuir, tanto el tiempo de entrenamiento, como el consumo energético.

\bigskip
Para seleccionar las características más relevantes en la clasificación, hemos utilizado una herramienta desarrollada
por Jorge Hermo https://github.com/jorgehermo9/mrmr-enhanced.

Explicar que hace el algoritmo mrmrmrmrmrmr enhanced edition
...
para cada una de ellas (ordenadas por order de relevancia) en las Tablas \ref{Tab:Features_5_1} y \ref{Tab:Features_5_2}.
