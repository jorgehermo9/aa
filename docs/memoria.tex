...
Esta herramienta utiliza el concepto de información mutua para realizar un ranking de las características del \textit{dataset},
siguiendo el algoritmo de máxima relevancia-mínima redundancia (\textit{mRMR}), propuesto por \cite{peng2005mrmr}. Este algoritmo busca obtener un ranking
de características que maximice la relevancia (ganancia de información) respecto a la clase, pero que también se minimice
la redundancia entre características.
...
para cada una de ellas (ordenadas según el ranking producido por el algoritmo \textit{mRMR}) en las Tablas \ref{Tab:Features_5_1}, \ref{Tab:Features_5_2} y \ref{Tab:Features_5_3}.
...
\bigskip
Se muestra en la tabla \ref{confusion_matrix_5} la matriz de confusión del mejor
...
con una separación de $20\%$ de los patrones para test.
...
Tras los buenos resultados del sistema podemos concluir que es útil para diferenciar dos notas de piano con muy buena precisión. 
Esta función aislada puede ser usada en multiple herramientas de afinación o de aprendizaje elemental para los mas novatos que quieran practicar su oido musical.
...
más complejos como puede ser la dificil tarea de la transcripción de musica automñatica.

\bigskip
Teniendo en cuenta la eficacia de nuestro sistema cabe destacar que tal como dijimos en la introduccion, este sistema se puede ampliar para ser capaz de
 reconocer mas de dos notas al mismo tiempo o incluso reconocer acordes o tonalidades.

\bigskip
La metodología que seguimos a lo largo de esta memoria también puede ser enfocada para otros instrumentos ya que algunas características que usamos en nuestro sistema
tienen la misma naturaleza en otros instrumentos como puede ser una guitarra, un bajo o un arpa.
...
Aplicaciones como Shazam, Spotify, Tidal o Youtube podrian dar distintos usos como el reconocimiento de canciones, covers o clasificaciones por géneros musicales 
