...
Así, obtuvimos para cada característica, la media y la desviación típica. Se muestran dichos datos en la Tabla \ref{Tab:Features}.
...
\begin{itemize}
	...
	\item \textit{std\textsubscript{i}} indica la {desviación típica de la intensidad} en el intervalo \textit{i} en frecuencia.
	\item \textit{max\textsubscript{i}} indica el máximo de la intensidad en el intervalo \textit{i} en frecuencia.
\end{itemize}	
...
\bigskip
En la Tabla \ref{tab:confusion_matrix} podemos ver una matriz de confusión para la RNA entrenada anteriormente. Las predicciones se hicieron sobre un conjunto
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1.0\linewidth]{assets/best_rna_train.pdf}
